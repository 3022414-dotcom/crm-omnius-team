...
*(Нет открытых вопросов — требования в описании исчерпывающие)*
...
- **FR-002**: В карточке Deal ДОЛЖНО присутствовать поле Deal Owner — выпадающий список пользователей системы, редактируемый пользователями с правом записи.
